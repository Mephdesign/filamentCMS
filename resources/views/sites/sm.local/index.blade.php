...
<script>
    ...
    function openGallery(key) {
        ...
        // Tworzymy odwróconą kopię tablicy zdjęć dla bieżącego projektu
        currentProjectImages = [...project.images].reverse();

        let htmlContent = '';
        currentProjectImages.forEach((url, index) => {
            // Indeks odnosi się teraz do odwróconej tablicy w currentProjectImages
            htmlContent += `
